...
import { addLikeds, addToBasket, unLiked } from "../../../functions";
import { FaStar, FaHeart, FaRegHeart } from "react-icons/fa";

const ProductCard = ({ item, likeds, setLikeds, setResponse, setBasketValue }) => {
            ...
            <div className="vns-product-body">
                ...
                <div className="vns-product-actions">
                    ...
                    <button
                        ...
                        onClick={() =>  addToBasket(item._id, setLoading, false, setBasketValue, setResponse, false, false)}
                    >
                        {
